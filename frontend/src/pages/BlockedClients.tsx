...
const BlockedClients = () => {
    const [blockedClients, setBlockedClients] = useState<ClientType[]>([]);
            ...
            try {
                ...
                await axios
                    ...
                    .then((res) => {
                        ...
                        const blockedClients = res.data.filter(
                            (client: ClientType) => client.blocked
                        );
                        setBlockedClients(blockedClients);
                        return;
                    })
                    .catch((err) => {
    ...
    return (
        <div className="w-full h-full overflow-auto p-1 md:p-5">
            <h1 className="text-3xl font-semibold mb-5">Blocked Clients</h1>
            <div className="w-full flex flex-col items-center">
                ...
                {loading ? (
                    ...
                    <div className="w-full px-2">
                        ...
                        {blockedClients.length > itemsPerPage && (
